...
export default class DataService {
    ...
    vaultData = [
        ...
        },
        {
            ...
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_MEB_SMEB.xlsx'
        },
        {
            'id': 'EV20192',
            'sector': 'Economic Vulnerability',
        ...
        },
        {
            ...
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_foodsecurity_Coping.xlsx'
        },
        {
            'id': 'FS20192',
            'sector': 'Food security',
        ...
        },
        {
            ...
            'indicator': 'Food Security Classification',
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_foodsecurity_Food_Security.xlsx'
        },
        {
            'id': 'FS201932',
            'sector': 'Food security',
        ...
        },
        {
            ...
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_foodsecurity_Foodconsumption.xlsx'
        },
        {
            'id': 'FS201937',
            'sector': 'Food security',
        ...
        },
        {
            ...
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_foodsecurity_foodconsumptionscorenutrition.xlsx'
        },
        {
            'id': 'FS201959',
            'sector': 'Food security',
        ...
        },
        {
            ...
            'indicator': 'Reduced Coping Strategy Index',
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_foodsecurity_rCSI.xlsx'
        },
        {
            'id': 'LIV201957',
            'sector': 'Livelihoods',
        ...
        },
        {
            ...
            'year': '2019',
            'download_link': '/vasyr/files/fs_livelihoods_economic/Vault_Expenditure.xlsx'
        },
        {
            'id': 'EXP20192',
            'sector': 'Expenditure',
