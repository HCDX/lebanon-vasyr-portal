...
export default class DataService {
    ...
    vaultData = [
        ...
        Average Debt per Household(only Households with Debt)
        ", year: "
        2019 ", download_link: "\
        vasyr\ files\ economic_vulnerability\ Vault_MEB_SMEB.xlsx "}, "
        "{id: "
        EV2019008 ", sector:"
        Economic Vulnerability ", indicator: "
        Average Debt per Capita(only Households with Debt)
        ", year: "
        2019 ", download_link: "\
        vasyr\ files\ economic_vulnerability\ Vault_MEB_SMEB.xlsx "}, " {
            id: "EV2019009",
